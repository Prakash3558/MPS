    ...
    <header className="sticky top-0 z-40 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border-b border-slate-200/80 dark:border-slate-800/80 shadow-xs transition-all duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 py-2.5 sm:py-3 flex items-center justify-between">
        ...
        <div className="flex sm:hidden items-center gap-1.5">
          <a
            href="/portal"
            className="flex items-center gap-1 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold text-[11px] px-2.5 py-1 rounded-full shadow-xs"
          ...
          <button
            type="button"
            onClick={() => setDownloadModalOpen(true)}
            className="flex items-center gap-1 bg-amber-400 text-slate-950 font-bold text-[11px] px-2.5 py-1 rounded-full shadow-xs cursor-pointer"
            title="Download App"
          >
          ...
          <button
            onClick={toggleDarkMode}
            className="p-1.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-200/80 dark:border-slate-700/80"
            aria-label="Toggle theme"
          >
          ...
          <button
            ...
            className="p-1.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200/80 dark:border-slate-700/80"
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="lg:hidden bg-white/95 dark:bg-slate-900/95 backdrop-blur-2xl border-b border-slate-200 dark:border-slate-800 px-5 py-4 space-y-3 text-sm font-medium animate-in slide-in-from-top-3 duration-200">
          {/* Top Quick Actions */}

        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
          <div className="space-y-2 max-w-xl">
            <span className="text-[11px] font-semibold uppercase tracking-widest text-slate-700 dark:text-slate-300 bg-slate-200/60 dark:bg-slate-800/80 border border-slate-300/50 dark:border-slate-700/60 px-3.5 py-1 rounded-full inline-block">
              <EditableText blockKey="gallery.badge" defaultText="Campus Life" />
            </span>
            ...
            <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
              <EditableText blockKey="gallery.subtext" defaultText="Glimpses of academic milestones, sports competitions, science fairs, and campus life." />
            </p>
          </div>
          ...
          <div className="flex items-center gap-2 self-end md:self-auto flex-shrink-0">
            ...
            >
              <EditableIcon iconKey="gallery.btnIcon" defaultIcon="Image" defaultColor="#f59e0b" size={14} />
              <span><EditableText blockKey="gallery.allPhotosBtn" defaultText="All Photos" /> ({gallery.length})</span>
            </button>
          </div>
        </div>
          ...
          {gallery.map((item, idx) => (
            ...
            >
              ...
              <div className="aspect-[16/11] overflow-hidden relative bg-slate-100 dark:bg-slate-800">
                ...
                {/* Category Badge */}
                <span className="absolute top-3 left-3 bg-black/60 backdrop-blur-md text-white text-[10px] font-medium uppercase tracking-wider px-2.5 py-0.5 rounded-full border border-white/20">
                  <EditableText blockKey={`gallery.${item.id}.category`} defaultText={item.category} />
                </span>
